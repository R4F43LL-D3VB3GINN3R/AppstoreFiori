		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "SBX Informática",
									"targetURL": "#sbxrlabcappstore-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sbxrlabcappstore-display": {
								"semanticObject": "sbxrlabcappstore",
								"action": "display",
								"description": "SBX Informática",
								"title": "SBX Informática",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sbx.rla.bc.appstore",
									"url": sap.ui.require.toUrl("sbx/rla/bc/appstore")
								}
							}
						}
					}
